...
/>
      ...
      {/* Navbar */}
     <nav className="max-w-7xl mx-auto flex items-center justify-between px-8 py-6 relative z-10">
  ...
  <a href="#contact" className="hover:text-pink-500 transition">
    Contact
      ...
      className="flex flex-col items-center justify-center text-center mt-20 mx-auto px-8 py-20 relative z-10 backdrop-blur-xl bg-white/50 rounded-[40px] shadow-2xl w-[90%] max-w-4xl border border-white/40"
      >
        <motion.img
  src={profile}
  alt="Dhvani"
...
/>
        ...
        <div className="mt-10 flex gap-5">
          ...
          <button className="bg-[#4b1f3a] text-white px-7 py-3 rounded-full hover:scale-110 transition duration-300 shadow-lg">
            View Projects
          </button>

          <button className="border border-[#4b1f3a] px-7 py-3 rounded-full hover:bg-[#4b1f3a] hover:text-white hover:scale-110 transition duration-300">
            Contact Me
          </button>
          </div>
...
<section id="skills" className="mt-32 px-10 relative z-10">

  <h2 className="text-4xl font-bold text-center mb-16">
    My Skills
  </h2>

  <motion.div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-6xl mx-auto">
...
<section id="projects" className="mt-36 px-8 relative z-10">
